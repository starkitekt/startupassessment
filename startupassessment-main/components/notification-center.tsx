...
import { TYPE_ICON_MAP, TYPE_LABEL_MAP } from "@/lib/mappings"
              ...
              {Object.keys(filteredNotifications).length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {activeTab === "all"
                      ? "No notifications"
                      : `No ${TYPE_LABEL_MAP[activeTab as NotificationType]?.toLowerCase() || "notifications"}`}
                  </p>
                </div>
              ) : (
                  ...
                  {Object.entries(groupedNotifications()).map(([date, notifications]) => (
                    <div key={date} className="space-y-1">
                      ...
                      {notifications.map((notification) => (
                        ...
                        >
                          <div className="flex-shrink-0 mt-0.5">{TYPE_ICON_MAP[notification.type] || <Info className="h-4 w-4 text-blue-500" />}</div>
