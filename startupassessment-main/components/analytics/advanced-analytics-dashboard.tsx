      ...
      <Tabs defaultValue="overview" className="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={REVENUE_DATA} theme={bloombergTheme}>
          ...
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={REVENUE_DATA} theme={bloombergTheme}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="month" />
                  <YAxis />
                  <Tooltip formatter={(value) => [`$${value.toLocaleString()}`, ""]} />
        ...
        <TabsContent value="procurement" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={PROCUREMENT_DATA} theme={bloombergTheme}>
                  <CartesianGrid strokeDasharray="3 3" />
        ...
        <TabsContent value="calendar" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={CALENDAR_UTILIZATION_DATA} theme={bloombergTheme}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="day" />
                  <YAxis />
                  <Tooltip />
