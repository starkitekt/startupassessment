...
import { STATUS_COLOR_MAP, PRIORITY_COLOR_MAP } from "@/lib/mappings"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="h-[300px]">
            <ChartContainer config={chartConfig} className="w-full h-full" theme={bloombergTheme}>
              <ResponsiveContainer>
        ...
        <Card>
          ...
          <CardContent className="h-[300px] flex items-center justify-center">
            <ChartContainer config={chartConfig} className="w-full h-full max-h-[250px]" theme={bloombergTheme}>
              <ResponsiveContainer>
                <PieChart>
                  <Pie
                  ...
                  >
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge variant="outline" className={cn("text-xs", STATUS_COLOR_MAP[area.status] || "bg-red-500/20 text-red-400 border-red-500/30")}>
                          {area.status}
                        </Badge>
                      </div>
                    </CardHeader>
                        ...
                        <TableCell>
                          <Badge
                            ...
                            className={cn(
                              ...
                              PRIORITY_COLOR_MAP[task.priority] || "border-green-500 text-green-400",
                            )}
                          >
                            {task.priority}
                          </Badge>
